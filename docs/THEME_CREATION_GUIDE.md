...
Tài liệu này hướng dẫn tạo một theme PNG ngoài EXE cho MCW Launcher Beta 9.
...
## 9. Fallback và theme chưa hoàn chỉnh
...
## 10. Đóng gói cùng release

Công cụ release tự copy toàn bộ `themes/`:

```powershell
python tools/build_release_zip.py --exe ".\dist\MCW Launcher.exe" --version "0.5.0-beta.9"
```
