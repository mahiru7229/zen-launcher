...
class LaunchController(BaseController):
    ...
    def launch(self) -> None:
        ...
        def task() -> dict[str, Any]:
            ...
            return MinecraftExecutor.run(instance=instance, authentication=authentication, account=account, debug_mode=debug_mode, on_progress=self._on_progress)
    ...
    def _on_task_failed(self, task_id: str, error: Exception) -> None:
        if task_id == self.TASK_ID:
            self._emit_error("Launch Minecraft", error)
