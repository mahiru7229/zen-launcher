...
class FileBatchProgress:
    ...
    def __init__(self, reporter: ProgressReporter | None, stage: ProgressStage, message: str, total: int, clock: Callable[[], float] | None = None) -> None:
    ...
    def start(self) -> None:
        self._emit(current=0, bytes_per_second=None)
    ...
    def _emit(self, current: int, bytes_per_second: float | None) -> None:
